...
def criterio6(horario, minimos_equipa_A_manha, minimos_equipa_A_tarde, minimos_equipa_B_manha, minimos_equipa_B_tarde, Prefs):
    ...
    equipe_A, equipe_B, ambas = identificar_equipes(Prefs)  # A função identificar_equipes deve estar definida em algum lugar
...
print("Critério 6 - Violação da sequência de turnos (mínimos por equipe):                                   ", f6_opt)
